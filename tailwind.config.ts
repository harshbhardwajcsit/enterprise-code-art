  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'display-sm': ['3.5rem', { lineHeight: '1.08', letterSpacing: '-0.02em', fontWeight: '800' }],
        'heading-1': ['3rem', { lineHeight: '1.1', letterSpacing: '-0.02em', fontWeight: '700' }],
        'heading-2': ['2.25rem', { lineHeight: '1.15', letterSpacing: '-0.01em', fontWeight: '700' }],
...
// Plugin that adds each Tailwind color as a CSS variable (e.g. --blue-500)
